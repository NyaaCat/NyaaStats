        ...
        <div class="panel-body">
          <div class="flex items-center">
            ...
            <div class="flex-1">
              <h4 class="my-0">
                {{ playername[0]
                }}<em v-if="playername[1]" class="not-italic text-red-600">{{
                  playername[1]
                }}</em
                >{{ playername[2] }}
              </h4>
              ...
              >
                <svg
                  ...
                  viewBox="0 0 24 24"
                  style="width: 1em; height: 1em; fill: currentColor; margin-right: 4px;"
                >
                  <path
                ...
                {{ usedPlayername[0]
                }}<em class="not-italic text-red-600">{{
                  usedPlayername[1]
                }}</em
                >{{ usedPlayername[2] }}
              </h5>
              <h6 v-else-if="matchedUuid[1]" class="text-gray-600 font-mono mt-4 mb-0 break-all">
                {{ matchedUuid[0]
                }}<em class="not-italic text-red-600">{{ matchedUuid[1] }}</em
                >{{ matchedUuid[2] }}
              </h6>
            </div>
          </div>
