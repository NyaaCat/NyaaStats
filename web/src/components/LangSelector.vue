<template>
  <span class="block w-6 h-6 relative">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="absolute top-0 left-0 w-full h-full fill-gray-400">
    ...
    <select v-model="config.lang" class="absolute top-0 left-0 w-full h-full opacity-0 appearance-none">
